...
from vaery_unsupervised.scripts.utils import plot_gene_expression_panels
...
EXPERIMENT_DESCRIPTION = (f"SIXCE: mlp 256, proj 48, 2k-cells")
...
def main():
    ...
    if not RUN_INFERENCE:
        ...
        # Or let's generate a figure for all genes because why not
        marker_list = transcript_df["gene"].unique().tolist()
        assert not any("blank" in g.lower() for g in marker_list), \
            "Error: some genes contain 'Blank' in their name!"
