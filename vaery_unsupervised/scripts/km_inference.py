...
#%%
checkpoint_path = "/mnt/efs/aimbl_2025/student_data/S-KM/logs/fastloadingVAE_beta0.0.1/version_1/checkpoints/epoch=9-step=430.ckpt"
model = SpatialVAE.load_from_checkpoint(checkpoint_path=checkpoint_path)
