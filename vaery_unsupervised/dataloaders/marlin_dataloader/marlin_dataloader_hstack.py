#%%
# This dataloader was used for my second succesful run of 500 genes with the gemini-generated network.
# It stacks the images horizontally until they are square.
